...
export type ThemeContextValue<T extends ThemeToken, S extends ColorSchemaName> = {
  atoms: AtomsStyle<T>
  colorScheme: S
}
...
export const ThemeContext = createContext<ThemeContextValue<ThemeToken, string>>(defaultValue)

export function ThemeColorProvider<T extends ThemeToken, S extends ColorSchemaName>({
  children,
  colorScheme,
  themeModes,
  ...
  return <ThemeContext.Provider value={{ atoms, colorScheme }}>{children}</ThemeContext.Provider>
}
